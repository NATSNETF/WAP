...
let adder1 = makeAdder(2);
 console.log(adder1(10));//____________ console.log(adder1(14));//______________
let adder2 = makeAdder(5); 
console.log(adder2(10));//______________ console.log(adder2(14));//_____________
//6.
 function callMe(){
      console.log("callMe") 
